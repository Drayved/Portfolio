...
const Footer = ( ) => {
    ...
    return(
        <footer className=" py-10 mt-32 border-t">
            <div className="flex flex-col items-center sm:flex-row pl-10 sm:justify-between lg:w-[80%] lg:mx-auto">
                <p className="flex flex-col">Built and Designed by<span className="text-center sm:text-left">David Riley</span> </p>
                <a className="my-8 sm:my-0 border py-3 px-12 btn-hover font-semibold text-lg" href="https://docs.google.com/document/d/1K-TI-o4oTf1njuind_5i-n4trzjysyPxSXZN1UVnSz4/edit?usp=sharing" target="_blank">Resume</a>
