    ...
    return(
        <footer className=" py-10 mt-32 border-t">
            <div className="flex flex-col items-center sm:flex-row sm:justify-between lg:w-[85%] lg:mx-auto">
                ...
                <a className="my-8 sm:my-0 border py-3 px-12 btn-hover font-semibold text-lg" href="https://docs.google.com/document/d/1LrrNYW7TJ7JSdLVynRL4VGzmreRLG2wFWPCyWKNyksQ/edit?usp=sharing" target="_blank">Resume</a>
