...
const About = () => {
    ...
    return(
        <section id='about' ref={ref} className={`section bg-[#121212] flex flex-col lg:flex-row mt-60 md:mt-[35rem] items-center justify-center w-[90%] max-w-[1150px] mx-auto ${inView ? 'visible' : ''}`}>
